	...
	return (
		<div className="site_content">
			...
			<MyContext.Provider value={{ sortAll, setNewCurrentYear, setNewActiveGeners, set_LIST_TO_SHOW, setNewFavoriteToReadList }}>
				...
				<CreateFilmsList listToShow={LIST_TO_SHOW} allFilmsList={FILMS} favotiteFilmsList={FAVORITE_LIST}
					toReadFilmsList={TO_READ_LIST} currentYear={currentYear} activeGeners={activeGeners} />
